    ...
    <section id="about" className="topography bg-night section-pad">
      <div className="container-shell grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] xl:gap-24">
        <ScrollReveal variant="left">
          ...
          <article className="motion-card max-w-3xl rounded-[40px] border border-white/10 bg-ink/95 p-7 font-mono text-sm leading-7 text-white/85 shadow-glow md:p-10 md:text-base">
        ...
        <ScrollReveal variant="right" delay={140} className="relative mx-auto w-full max-w-xl">
          <div className="noise-layer overflow-hidden rounded-2xl border border-white/10 shadow-glow">
